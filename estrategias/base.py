...
class EstrategiaBase:
    def __init__(self, nombre="Estrategia Generica"):
        ...
        self.max_precio_visto = 0.0 # Para trailing stops
    ...
    def proximo_paso(self, vela_actual) -> Literal['ESPERAR', 'VENDER_LIQUIDACION', 'VENDER_STOP_LOSS', 'VENDER_BREAK_EVEN', 'VENDER_TRAILING_STOP', 'COMPRAR_1.5X', 'COMPRAR_1.2X', 'COMPRAR_1X', 'VENDER_CRUCE']:
        """
